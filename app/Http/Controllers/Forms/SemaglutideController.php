...
class SemaglutideController extends FormsController
{
    protected $form = 'semaglutide';
    protected $formName = 'Semaglutide Consent';
    protected $routePrefix = 'formSemaglutide';
